...
#define ui_mode (g_ctx->ui->ModeRef())
#define menu_index (g_ctx->ui->MenuIndexRef())
#define shift_menu_index (g_ctx->ui->ShiftMenuIndexRef())
#define perform_index (g_ctx->ui->PerformIndexRef())
#define amp_fader_index (g_ctx->ui->AmpFaderIndexRef())
#define flt_fader_index (g_ctx->ui->FltFaderIndexRef())
#define fx_fader_index (g_ctx->ui->FxFaderIndexRef())
#define fx_chain_order (g_ctx->ui->FxChainOrderRef())
#define fx_window_active (g_ctx->ui->FxWindowActiveRef())
#define amp_window_active (g_ctx->ui->AmpWindowActiveRef())
#define flt_window_active (g_ctx->ui->FltWindowActiveRef())
#define shift_prev_mode (g_ctx->ui->ShiftPrevModeRef())
#define record_input (g_ctx->ui->RecordInputRef())
#define load_selected (g_ctx->ui->LoadSelectedRef())
#define load_scroll (g_ctx->ui->LoadScrollRef())
#define request_load_scan (g_ctx->ui->RequestLoadScanRef())
#define list_build_pending (g_ctx->ui->ListBuildPendingRef())
#define request_load_sample (g_ctx->ui->RequestLoadSampleRef())
#define request_load_index (g_ctx->ui->RequestLoadIndexRef())
#define load_in_progress (g_ctx->ui->LoadInProgressRef())
#define load_cookie_next (g_ctx->ui->LoadCookieNextRef())
#define load_cookie_active (g_ctx->ui->LoadCookieActiveRef())
#define load_target_is_edt (g_ctx->ui->LoadTargetIsEdtRef())
#define load_context (g_ctx->ui->LoadContextRef())
#define loader_state (g_ctx->ui->LoaderStateRef())
#define load_success_count (g_ctx->ui->LoadSuccessCountRef())
#define load_fail_budget_count (g_ctx->ui->LoadFailBudgetCountRef())
#define load_fail_io_count (g_ctx->ui->LoadFailIoCountRef())
#define wav_file_count (g_ctx->ui->WavFileCountRef())
#define sd_mounted (g_ctx->ui->SdMountedRef())
#define sd_present (g_ctx->ui->SdPresentRef())
#define sd_fault (g_ctx->ui->SdFaultRef())
#define sd_fault_text (g_ctx->ui->SdFaultTextRef())
#define sd_retries_remaining (g_ctx->ui->SdRetriesRemainingRef())
#define sd_init_in_progress (g_ctx->ui->SdInitInProgressRef())
#define sd_init_done (g_ctx->ui->SdInitDoneRef())
#define sd_init_success (g_ctx->ui->SdInitSuccessRef())
#define sd_init_start_ms (g_ctx->ui->SdInitStartMsRef())
#define sd_init_next_ms (g_ctx->ui->SdInitNextMsRef())
#define sd_init_result_until_ms (g_ctx->ui->SdInitResultUntilMsRef())
#define sd_init_draw_next_ms (g_ctx->ui->SdInitDrawNextMsRef())
#define sd_init_attempts (g_ctx->ui->SdInitAttemptsRef())
#define sd_init_prev_mode (g_ctx->ui->SdInitPrevModeRef())
#define save_in_progress (g_ctx->ui->SaveInProgressRef())
#define save_done (g_ctx->ui->SaveDoneRef())
#define save_success (g_ctx->ui->SaveSuccessRef())
#define save_started (g_ctx->ui->SaveStartedRef())
#define save_start_ms (g_ctx->ui->SaveStartMsRef())
#define save_result_until_ms (g_ctx->ui->SaveResultUntilMsRef())
#define save_draw_next_ms (g_ctx->ui->SaveDrawNextMsRef())
#define save_prev_mode (g_ctx->ui->SavePrevModeRef())
#define save_filename (g_ctx->ui->SaveFilename())
#define save_frames_written (g_ctx->ui->SaveFramesWrittenRef())
#define delete_mode (g_ctx->ui->DeleteModeRef())
#define delete_prev_mode (g_ctx->ui->DeletePrevModeRef())
#define request_delete_scan (g_ctx->ui->RequestDeleteScanRef())
#define request_delete_file (g_ctx->ui->RequestDeleteFileRef())
#define request_delete_index (g_ctx->ui->RequestDeleteIndexRef())
#define delete_confirm (g_ctx->ui->DeleteConfirmRef())
#define delete_confirm_name (g_ctx->ui->DeleteConfirmName())
#define phones_volume (g_ctx->ui->PhonesVolumeRef())
#define delete_in_progress (g_ctx->ui->DeleteInProgressRef())
#define delete_cookie_next (g_ctx->ui->DeleteCookieNextRef())
#define delete_cookie_active (g_ctx->ui->DeleteCookieActiveRef())
#define wav_files (g_ctx->ui->WavFiles())
#define loaded_sample_name (g_ctx->ui->LoadedSampleName())
#define load_lines (g_ctx->ui->LoadLinesRef())
#define load_line_height (g_ctx->ui->LoadLineHeightRef())
#define load_chars_per_line (g_ctx->ui->LoadCharsPerLineRef())
#define load_scan_start_ms (g_ctx->ui->LoadScanStartMsRef())
#define current_sample_context (g_ctx->ui->CurrentSampleContextRef())
#define edt_sample_context (g_ctx->ui->EdtSampleContextRef())
#define load_mode_index (g_ctx->ui->LoadModeIndexRef())
#define load_stub_mode (g_ctx->ui->LoadStubModeRef())
#define sample_length (g_ctx->ui->SampleLengthRef())
#define sample_play_start (g_ctx->ui->SamplePlayStartRef())
#define sample_play_end (g_ctx->ui->SamplePlayEndRef())
#define sample_rate (g_ctx->ui->SampleRateRef())
#define sample_channels (g_ctx->ui->SampleChannelsRef())
#define sample_loaded (g_ctx->ui->SampleLoadedRef())
#define playback_active (g_ctx->ui->PlaybackActiveRef())
#define playback_rate (g_ctx->ui->PlaybackRateRef())
#define playback_phase (g_ctx->ui->PlaybackPhaseRef())
#define playback_reverse (g_ctx->ui->PlaybackReverseRef())
#define g_perform_voices_active (*g_ctx->perform_voices_active)
#define g_audio_ui_state_buf (g_ctx->ui->AudioUiStateBuf())
#define g_audio_ui_state_idx (g_ctx->ui->AudioUiStateIdxRef())
#define g_audio_recording_active (g_ctx->ui->AudioRecordingActiveRef())
#define g_active_voice_count (g_ctx->ui->ActiveVoiceCountRef())
#define g_delay_time_alpha (g_ctx->ui->DelayTimeAlphaRef())
#define g_delay_param_alpha (g_ctx->ui->DelayParamAlphaRef())
...
#define reverb_wet (g_ctx->ui->ReverbWetRef())
#define reverb_pre (g_ctx->ui->ReverbPreRef())
#define reverb_damp (g_ctx->ui->ReverbDampRef())
#define reverb_decay (g_ctx->ui->ReverbDecayRef())
#define delay_wet (g_ctx->ui->DelayWetRef())
#define delay_time (g_ctx->ui->DelayTimeRef())
#define delay_feedback (g_ctx->ui->DelayFeedbackRef())
#define delay_spread (g_ctx->ui->DelaySpreadRef())
#define delay_freeze (g_ctx->ui->DelayFreezeRef())
#define fx_s_wet (g_ctx->ui->FxSWetRef())
#define sat_drive (g_ctx->ui->SatDriveRef())
#define sat_tape_bump (g_ctx->ui->SatTapeBumpRef())
#define sat_bit_reso (g_ctx->ui->SatBitResoRef())
#define sat_bit_smpl (g_ctx->ui->SatBitSmplRef())
#define fx_c_wet (g_ctx->ui->FxCWetRef())
#define mod_depth (g_ctx->ui->ModDepthRef())
#define chorus_rate (g_ctx->ui->ChorusRateRef())
#define sat_mode (g_ctx->ui->SatModeRef())
#define chorus_mode (g_ctx->ui->ChorusModeRef())
#define chorus_wow (g_ctx->ui->ChorusWowRef())
#define tape_rate (g_ctx->ui->TapeRateRef())
#define fx_params_dirty (g_ctx->ui->FxParamsDirtyRef())
#define audio_params_dirty (g_ctx->ui->AudioParamsDirtyRef())
#define sat_params_initialized (g_ctx->ui->SatParamsInitializedRef())
#define reverb_params_initialized (g_ctx->ui->ReverbParamsInitializedRef())
#define delay_params_initialized (g_ctx->ui->DelayParamsInitializedRef())
#define mod_params_initialized (g_ctx->ui->ModParamsInitializedRef())
#define amp_attack (g_ctx->ui->AmpAttackRef())
#define amp_decay (g_ctx->ui->AmpDecayRef())
#define amp_sustain (g_ctx->ui->AmpSustainRef())
#define amp_release (g_ctx->ui->AmpReleaseRef())
#define fx_detail_index (g_ctx->ui->FxDetailIndexRef())
#define fx_detail_param_index (g_ctx->ui->FxDetailParamIndexRef())
#define flt_cutoff (g_ctx->ui->FltCutoffRef())
#define flt_res (g_ctx->ui->FltResRef())
#define preview_hold (g_ctx->ui->PreviewHoldRef())
#define fx_chain_fade_gain (g_ctx->ui->FxChainFadeGainRef())
#define fx_chain_fade_target (g_ctx->ui->FxChainFadeTargetRef())
#define fx_chain_fade_samples_left (g_ctx->ui->FxChainFadeSamplesLeftRef())
#define fx_chain_pause_pending (g_ctx->ui->FxChainPausePendingRef())
#define fx_chain_paused (g_ctx->ui->FxChainPausedRef())
#define fx_chain_last_move_ms (g_ctx->ui->FxChainLastMoveMsRef())
#define preview_active (g_ctx->ui->PreviewActiveRef())
#define preview_index (g_ctx->ui->PreviewIndexRef())
#define preview_sample_rate (g_ctx->ui->PreviewSampleRateRef())
#define preview_channels (g_ctx->ui->PreviewChannelsRef())
#define preview_rate (g_ctx->ui->PreviewRateRef())
#define preview_read_frac (g_ctx->ui->PreviewReadFracRef())
#define preview_read_index (g_ctx->ui->PreviewReadIndexRef())
#define preview_write_index (g_ctx->ui->PreviewWriteIndexRef())
#define preview_data_offset (g_ctx->ui->PreviewDataOffsetRef())
#define preview_fade_samples_left (g_ctx->ui->PreviewFadeSamplesLeftRef())
#define preview_fade_samples_total (g_ctx->ui->PreviewFadeSamplesTotalRef())
#define preview_pending_start (g_ctx->ui->PreviewPendingStartRef())
#define preview_pending_start_ms (g_ctx->ui->PreviewPendingStartMsRef())
#define preview_underrun_count (g_ctx->ui->PreviewUnderrunCountRef())
#define preview_rb_min_level (g_ctx->ui->PreviewRbMinLevelRef())
#define preview_stream_cookie (g_ctx->ui->PreviewStreamCookieRef())
#define preview_stream_cookie_active (g_ctx->ui->PreviewStreamCookieActiveRef())
#define preview_pp_ready (g_ctx->ui->PreviewPpReadyPtr())
#define preview_pp_active (g_ctx->ui->PreviewPpActiveRef())
#define preview_pp_pos (g_ctx->ui->PreviewPpPosRef())
#define preview_preload_frames (g_ctx->ui->PreviewPreloadFramesRef())
#define preview_preload_active (g_ctx->ui->PreviewPreloadActiveRef())
#define led1_level (g_ctx->ui->Led1LevelRef())
#define led1_phase_ms (g_ctx->ui->Led1PhaseMsRef())
#define record_anim_start_ms (g_ctx->ui->RecordAnimStartMsRef())
#define request_shift_redraw (g_ctx->ui->RequestShiftRedrawRef())
#define request_perform_redraw (g_ctx->ui->RequestPerformRedrawRef())
#define request_fx_detail_redraw (g_ctx->ui->RequestFxDetailRedrawRef())
#define delay_snow_next_ms (g_ctx->ui->DelaySnowNextMsRef())
#define midi_ignore_until_ms (g_ctx->ui->MidiIgnoreUntilMsRef())
#define g_job (g_ctx->ui->JobRef())
#define g_wf_job (g_ctx->ui->WaveformJobRef())
#define g_list_job (g_ctx->ui->FileListJobRef())
#define waveform_ready (g_ctx->ui->WaveformReadyRef())
#define waveform_dirty (g_ctx->ui->WaveformDirtyRef())
#define waveform_from_recording (g_ctx->ui->WaveformFromRecordingRef())
#define waveform_title (g_ctx->ui->WaveformTitleRef())
#define request_delete_redraw (g_ctx->ui->RequestDeleteRedrawRef())
#define waveform_compute_pending (g_ctx->ui->WaveformComputePendingRef())
#define waveform_compute_ctx (g_ctx->ui->WaveformComputeCtxRef())
#define trim_start (g_ctx->ui->TrimStartRef())
#define trim_end (g_ctx->ui->TrimEndRef())
#define sample_mem_used_bytes (*g_ctx->sample_mem_used_bytes)
#define sample_mem_free_bytes (*g_ctx->sample_mem_free_bytes)
#define waveform_cache_bytes (g_ctx->ui->WaveformCacheBytesRef())
...
void AppController::Init(AppContext* ctx)
{
	...
	MountSd();
	DrawMenu(menu_index);
	g_ctx->ui->SetLastDrawMs(System::GetNow());
}
...
void AppController::Tick(uint32_t /*now_ms*/)
{
	// remaining state lives in g_app
			...
			while (storage.DequeueEvent(ev))
			{
				...
				else if (ev.kind == StorageService::EventKind::PreviewOpenOk)
				{
					...
					if (preview_preload_active)
					{
						...
						g_ctx->audio->RequestAudioCmd(kCmdPreviewStart);
					}
				}
		...
		}
		{
			...
			{
				daisy::ScopedIrqBlocker irq;
				audio_events = g_ctx->audio->PopAudioEvents();
			}
		...
		ui.Tick(System::GetNow());
		{
			...
			{
				daisy::ScopedIrqBlocker irq;
				g_ctx->audio->SetAudioFlagsBits(bits);
			}
		}
		...
		if (button1_press)
		{
				...
				&& ui_mode != UiMode::Load)
			{
				...
				{
					g_ctx->audio->RequestPlaybackStart(kBaseMidiNote, false);
				}
		...
		const bool needs_draw = g_ctx->ui->IsDisplayUpdatePending()
